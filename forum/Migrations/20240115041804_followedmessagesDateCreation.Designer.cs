...
namespace forum.Migrations
{
    ...
    [Migration("20240115041804_followedmessagesDateCreation")]
    partial class followedmessagesDateCreation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostUser1", b =>
                {
                    b.Property<int>("AbonnePostsPostID")
                        .HasColumnType("int");

                    b.Property<string>("AbonneUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("AbonnePostsPostID", "AbonneUsersId");

                    b.HasIndex("AbonneUsersId");

                    b.ToTable("AbonneUsersPosts", (string)null);
                });
            ...
            modelBuilder.Entity("PostUser1", b =>
                {
                    b.HasOne("forum.Models.Post", null)
                        .WithMany()
                        .HasForeignKey("AbonnePostsPostID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("forum.Models.User", null)
                        .WithMany()
                        .HasForeignKey("AbonneUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
